...
class isAnagram242 {
	public static void main(String[] args) {
		System.out.println(isAnagram("abbc", "dfs"));
	}
...
class canConstruct383 {
	public static void main(String[] args) {
		System.out.println(canConstruct("abbc", "dfs"));
	}
...
class intersection349 {
	public static void main(String[] args) {
		System.out.println(intersection(new int[]{1, 2, 3, 4}, new int[]{2,3,4,5}));
	}
